...
async function handleSubmit() {
  ...
  try {
    const res = await loginRequest({ userName: userName.value, password: password.value })
...
<template>
  <div id="login">
    <div class="background">
      <div class="head"></div>
      <div class="loginFrom">
        <div class="loginyixin">欢迎登录QQ</div>
        <p>每一天，乐在沟通。</p>
        <div class="userName">
          <input type="text" placeholder="昵称" v-model="userName" />
        </div>
        <div class="password">
          <input type="password" placeholder="密码" v-model="password" @keypress.enter="handleSubmit" />
        </div>
        ...
        <div class="loginFoot clearfix">
          ...
          <a href="/register" class="a-right" @click="register">注册账户</a>
        </div>
        <div class="footer">
